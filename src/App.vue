    ...
    <div class="mb-5">
      ...
      >
        ...
        <template v-slot:computing>
          ...
          >
            <div
              class="position-sticky bg-white d-inline-block mt-5 p-3"
              style="top: 0;"
            >
              <svg
                aria-hidden="true"
...
import dataGdp from './data/data-gdp'
...
$table-cell-padding: 0.5rem; // default in bs5
$table-cell-padding-sm: 0.25rem; // default in bs5
*,
*::before,
*::after {
